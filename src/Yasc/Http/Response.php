...
class Yasc_Http_Response {
	...
	public function __construct($body = "", $status = 200, Array $headers = null) {
		$this->setBody($body);
		$this->setStatus($status);
		
		$this->_headers = new Yasc_Http_Header(array("Content-Type" => "text/html"));		
		if (null !== $headers) {
	...
	public function addHeaders(Array $headers) {
		$this->_headers = (array) $this->_headers + $headers;
